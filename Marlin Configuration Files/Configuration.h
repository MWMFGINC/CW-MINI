...
#define STRING_CONFIG_H_AUTHOR "(CW)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "CW MINI"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  80.3
  #define DEFAULT_BED_KI   11.6
  #define DEFAULT_BED_KD 370.5
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 25.4, 0, -.7 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 50, 30, 2 }
