...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_ZETA_X   0.01       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  33.0        // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y   0.01       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
 ...
 */ // DIRECT DRIVE K0.3  // BOWDEN DRIVE  K1.1
#define LIN_ADVANCE

#if ANY(LIN_ADVANCE, FT_MOTION)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.3 }    // (mm) Compression length per 1mm/s extruder speed, per extruder. Override with 'M900 T<tool> K<mm>'.
  #else
    #define ADVANCE_K 0.3        // (mm) Compression length for all extruders. Override with 'M900 K<mm>'.
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           800  // (seconds) Time limit before the nozzle is turned off for safety.
